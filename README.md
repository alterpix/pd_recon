...
## Installation
Ensure you have Python 3 and Golang installed.
...
```
Ensure `~/go/bin` is in your PATH (the script also adds it automatically).

## Usage
```bash
python3 pd_recon.py -d <target_domain> -m <mode>
```

### Examples
**1. Low Profile (Stealth)**
```bash
python3 pd_recon.py -d example.com -m low
```

**2. Standard Audit**
```bash
python3 pd_recon.py -d example.com -m medium
```

**3. Full Aggressive Scan**
```bash
python3 pd_recon.py -d example.com -m aggressive
```
